                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form action="InsertCollege.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" name="inputAssociateDeanAA" id="inputAssociateDeanAA" class="form-control" placeholder="معاون العميد للشؤون العلمية" required>
                                                        <label for="inputAssociateDeanAA">معاون العميد للشؤون العلمية</label>
                                                    </div>
