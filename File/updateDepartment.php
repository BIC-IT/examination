            ...
            <section class="todo-form">
                <form id="form-add-todo" method="post" action="editCollege.php" class="todo-input">
                    ...
                    <div class="modal-body">
                        ...
                        <fieldset class="form-group">
                            <input type="text" name="Number" value="<?php echo $department_data['Number'] ?>" class="new-todo-item-title form-control" placeholder="الرقم">
                        </fieldset>
                        <fieldset class="form-group">
                        ...
                        <fieldset class="form-group">
                            <input type="text" name="inputAssociateDeanSA" value="<?php echo $department_data['HeadOfDepartment'] ?>" class="new-todo-item-title form-control" placeholder=" رئيس القسم ">
                        </fieldset>
                        <fieldset class="form-group">
                            <input type="text" name="inputAssociateDeanAA" value="<?php echo $department_data['MaterialConformingDeposit'] ?>" class="new-todo-item-title form-control" placeholder="درجه القرار">

                        </fieldset>
                        <fieldset class="form-group">
                            <input type="text" name="Dean" value="<?php echo $department_data['NumberMaterialsStudentLoaded'] ?>" class="new-todo-item-title form-control" placeholder="درجه المواد المستوفيه للراسب">
                        </fieldset>
